...
<?php $baseurl = '/master-cook/' ?>
    ...
    <div class="bg-gray-100 mt-20">
        <form action="<?=$baseurl . 'chef-edit-kelas'?>" method="POST" class="flex flex-col space-y-5 mx-10">
            ...
            <div class="mb-4 border border-black py-4 rounded-md px-6">
                ...
                <textarea
                    ...
                    name="ringkasan" rows="4" placeholder=""><?=$kelas_masak['ringkasan']?></textarea>
            </div>
            ...
            <div class="mb-4 border border-black py-4 rounded-md px-6">
                ...
                <textarea
                    class="rounded-xl w-full py-2 px-3 text-gray-900 font-normal bg-transparent outline-none"
                    name="syarat_dan_ketentuan" rows="6" placeholder=""><?=$kelas_masak['syarat_dan_ketentuan']?></textarea>
            </div>
            ...
            <div class="flex items-center mb-5 border border-black py-2 px-6">
                ...
                <input name="pukul" value="<?=$kelas_masak['pukul']?>" required="" type="text" class=" flex-1 py-2 bg-gray-100 placeholder-gray-300 outline-none ">
            </div>

            <div class="flex items-center mb-5 border border-black py-2 px-6">
                <label class="w-20 inline-block text-right  text-black">Tanggal : </label>
                <input name="tanggal" value="<?=$kelas_masak['tanggal']?>" required="" type="text" class=" flex-1 bg-gray-100 py-2 placeholder-gray-300 outline-none ">
            </div>

            <div class="flex items-center mb-5 border border-black py-2 px-6">
                <label class="w-20 inline-block text-right  text-black">Lokasi :  </label>
                <input name="lokasi" value="<?=$kelas_masak['lokasi']?>" required="" type="text" class=" flex-1 bg-gray-100 py-2 placeholder-gray-300 outline-none ">
            </div>

            <div class="flex items-center mb-5 border border-black py-2 px-6">
                <label class="w-20 inline-block text-right  text-black">Harga : </label>
                <input name="harga" value="<?=$kelas_masak['harga']?>" required="" type="text" class=" flex-1 bg-gray-100 py-2 placeholder-gray-300 outline-none ">
            </div>

            <button class=" py-3 px-4 flex w-full justify-center bg-light-logo hover:bg-blue-900 text-white text-2xl font-normal shadow-md rounded-xl"
