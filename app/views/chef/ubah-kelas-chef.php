    ...
    <div class="bg-gray-100 mt-20">
        <div class="flex flex-col space-y-5 mx-10">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md border-2 border-black">
                ...
                <p class="text-gray-500 font-normal text-lg"> 1.  Peserta harus mendaftar dan membayar biaya kelas. Pembayaran bisa dilakukan secara offline di tempat.</p>
                <p class="text-gray-500 font-normal text-lg"> 2.  Peserta diharapkan mengenakan pakaian yang nyaman dan sepatu tertutup untuk keamanan.</p>
                <p class="text-gray-500 font-normal text-lg"> 3.  Semua peralatan dan bahan memasak akan disediakan. Peserta tidak perlu membawa peralatan pribadi.</p>
            </div>
