        ...
        <div class="bg-white overflow-hidden shadow rounded-lg ">           
            <div class=" px-4 py-5 sm:p-0">
                ...
                <div class="py-3 px-2 flex justify-end">
                    <button type="button"
                        class="mr-3 text-sm bg-light-logo hover:bg-blue-900 text-white py-1 px-4 rounded-full focus:outline-none focus:shadow-outline">Edit</button>
                    <button type="button"
                        class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-4 rounded-full focus:outline-none focus:shadow-outline ">Logout</button>
