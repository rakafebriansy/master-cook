                ...
                <table class="w-full table-fixed items-center">
                    ...
                    <tbody class="bg-white">
                        <tr>
                            ...
                            <td class="py-4 px-6 text-sm truncate font-normal">Elvy</td>
                            <td class="py-4 px-6 text-sm font-normal">@pacar_minggyu</td>
                            <td class="py-4 px-6 text-sm font-normal">085649554149</td>
