                ...
                <form method="POST" action="#">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input required="" id="nama" name="nama" type="text" class="appearance-none block w-full px-3 py-2 border border-black rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input required="" id="telp" name="telp" type="number" class="appearance-none block w-full px-3 py-2 border border-black rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                        </div>
                    </div>
                    ...
                    <div class="mt-6 text-end">
                        <a href="<?=$base . 'pengguna-login'?>" class="text-light-logo text-sm font-semibold cursor-pointer">Have Account</a>
                    </div> 
                </form>
