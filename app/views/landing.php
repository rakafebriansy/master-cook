...
<body class="font-roboto">
        ...
        <nav class="mx-auto flex max-w-6xl gap-8 px-6 transition-all duration-200 ease-in-out lg:px-12 py-4">
            ...
            <ul class="hidden items-center justify-center gap-10 md:flex">
                ...
                <li class="pt-1.5 font-dm text-sm font-normal text-slate-900">
                    <a href="cooking class.html">Kelas Memasak</a>
                </li>              
            </ul>
            <div class="flex-grow"></div>
            <div class="hidden items-center justify-center gap-10 md:flex">
                <a href="<?=$baseurl . 'role'?>" class="rounded-full  px-8 py-2 font-dm text-base font-medium text-white bg-light-logo shadow-md transition-transform duration-200 ease-in-out hover:bg-blue-900">Register</a>
                <a href="<?=$baseurl . 'login'?>"
                    class="rounded-full  px-8 py-2 font-dm text-base font-medium text-white bg-light-logo shadow-md transition-transform duration-200 ease-in-out hover:bg-blue-900">
                    Login
                </a>
            </div>
        </nav>
    ...
    <section class="py-20 bg-gray-100">
        <div class="container mx-auto">
            <div class="rounded-lg w-full py-12 bg-white text-center">
                <h1 class=" text-4xl font-semibold text-gray-800">Kelas Memasak</h1>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 pt-8">
                ...
                <div class="bg-gray-100 rounded-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-black text-base text-center">Masak bersama Chef Renata dengan olahan menu kreatif</p>
                        <div class="mt-4 flex items-center justify-between">
                            <div>
                ...
                <div class="bg-gray-100 rounded-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-black text-base text-center">Belajar resep rahasia menu andalan bintang 5 Chef Juna </p>
                        <div class="mt-4 flex items-center justify-between">
                            <div>
